...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def setUp(self):
        ...
        test_genre = Genre.objects.create(name='Fantasy')  # noqa: 841
    ...
    def test_logged_in_uses_correct_template(self):
        login = self.client.login(username='testuser1', password='12345')  # noqa: 841
        resp = self.client.get(reverse('my-borrowed'))
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_logged_in_with_permission_borrowed_book(self):
        login = self.client.login(username='testuser2', password='12345')  # noqa: 841
...
class AuthorCreateViewTest(TestCase):
    ...
    def setUp(self):
        ...
        test_author = Author.objects.create(first_name='John', last_name='Smith')  # noqa: 841
